...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
   ...
   if (this.user.role == "admin") {
     console.log("Malik jee");
     menu = MENU;
     console.log("if");
   } else if (this.user.role == "office") {
     console.log("office");
     menu =   [
     {
       label: 'office',
       ...
       subItems: [
        {
          label: 'Add Employee', 
          link: '/office-employees/add-employee',
          
        },
        
        {
          label: 'Employee List',
          link: '/office-employees/employee-list',
        },
        ...
        {
          label: 'Recevied Leaves',
          link: '/leave/leave-list',
         
        },
        
        {
          label: 'Attendence All',
          link: '/attendence-all',
        },
        {
          label: 'Leave All',
